...
public class DemoPrac6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nombre: "+emp1.getNombre()+"; antiguedad:"+ emp1.getantiguedad().getYears());

        Empleado emp2 = new Empleado("Ker");
        LocalDate datecontra2 = LocalDate.parse("2023-04-25");
        emp2.setFechaContratacion(datecontra2);
        System.out.println("Nombre: "+emp2.getNombre()+"; antiguedad:"+ emp2.getantiguedad().getYears());
